<script setup>
import FajrIcon from './icons/Prayers/Fajr.vue'
import DuhurIcon from './icons/Prayers/Duhur.vue'
import MaghribIcon from './icons/Prayers/Maghrib.vue'
import IshaaIcon from './icons/Prayers/Ishaa.vue'

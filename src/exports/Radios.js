export default {
  ...
  alfateh_alzubair: {
    name: 'الفاتح محمد الزبير- رواية الدوري عن أبي عمرو',
  ...
  almukhtasar_fi_alsiyra: {
    name: 'المختصر في السيرة النبوية - حلقات مختصرة عن سيرة نبيّنا محمد صلى الله عليه وسلم',
  ...
  alaikhtiarat_alfiqhayh_bin_baz: {

...
export default function PrivacyPolicyView() {
  return (
    <Page>
      <Heading className="mb-4" title="سياسة الخصوصية" subtitle="نلتزم بحماية خصوصيتك وشرح كيفية تعاملنا مع بياناتك" />
      ...
      <div className={styles.content}>
        ...
        <h2 className="h4 mt-4">١. البيانات التي نجمعها</h2>
        <ul>
          <li>
        ...
        <h2 className="h4 mt-4">٢. كيف نستخدم البيانات</h2>
        <ul>
        ...
        <h2 className="h4 mt-4">٣. الإشعارات</h2>
        <p>
        ...
        <h2 className="h4 mt-4">٤. الجهات الخارجية والخدمات المستخدمة</h2>
        <ul>
          <li>
          ...
          <li>
            ...
            <a href="https://api.mp3quran.net/radios/radio_arabic.json" target="_blank" rel="noopener noreferrer">
              MP3Quran
            </a>
        ...
        <h2 className="h4 mt-4">٥. تخزين البيانات والاحتفاظ بها</h2>
        <ul>

...
// OneSignal needs its own scope or it will replace the root Workbox worker.
// Keep this path and scope aligned with the OneSignal dashboard's custom worker settings.

...
<template>
  <div class="flex flex-col items-center justify-center gap-8 py-2 text-center">
    ...
    <button
      type="button"
      @click="sebha++"
      class="relative grid size-[min(17rem,78vw)] shrink-0 place-items-center rounded-full bg-card text-primary shadow-md transition duration-150 select-none active:scale-95 active:bg-accent active:shadow-sm"
    >

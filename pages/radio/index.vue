...
useSeoMeta({
  title: 'الإذاعة - رفيق',
  ogTitle: 'الإذاعة - رفيق',
  description: 'استمع إلى بث مباشر لمجموعة كبيرة من إذاعات القرآن الكريم والبرامج الإسلامية من مختلف أنحاء العالم.',
  ogDescription: 'استمع إلى بث مباشر لمجموعة كبيرة من إذاعات القرآن الكريم والبرامج الإسلامية من مختلف أنحاء العالم.',
    ...
    <ul class="list-group">
      ...
      >
        <div class="d-flex justify-content-between align-items-center">
          <NuxtLink :to="`/radio/${station.slug}`" class="flex-grow-1 radio-link">
